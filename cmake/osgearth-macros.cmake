...
macro(detect_osg_version)
    ...
    if(OSG_INCLUDE_DIR)
        ...
        set(_osg_Version_file "${OSG_DIR}/msvc/include/osg/Version")
		message("Osg Version file is " ${_osg_Version_file})
...
#            set(_osg_Version_file "${OSG_INCLUDE_DIR}/Headers/Version")
			set (osg_Version_file "${OSG_DIR}/msvc/include/osg/Version")
        endif()
